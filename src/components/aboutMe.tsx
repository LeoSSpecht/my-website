...
export const AboutMe = ({id}:{id:string}): JSX.Element => {
    ...
    const logo = (text:string, Icon: IconType, redirect: string, iconSize: number = 14): JSX.Element => {
        return(
            <a href={redirect} target="_blank" rel="noreferrer">
                <div className="flex my-2 not-phone:mx-3">
                    <span style={tagStyle} className="flex-center bg-slate-700 px-5 rounded-s w-28">{text}</span>
    ...
    return (
        ...
        <div id={id} className="w-auto px-5 py-12 bg-gradient-to-r from-[#F5F7FA] to-[#B8C6DB]">
            <div className="flex-column not-phone:flex-evenly">
                ...
                <div className="text-lg px-2 py-3 text-center max-w-[350px] not-phone:mr-auto">
                    <p className="leading-relaxed mb-3">I am an undergraduate Computer Science student at Michigan State.</p>
