...
const SkillCard = ({name, src} : skillCardProp): JSX.Element => {
    ...
    return (
        <div style={itemStyle} className="flex-center rounded-md shadow px-4 py-3 w-fit">
            <img alt="logo" className="w-6 object-contain mr-2" src={`${process.env.PUBLIC_URL + src}`} />
    ...
    const containerStyle = {
      ...
      return (
        <div id={id} className="mx-12 my-5">
            <h1 className="font-bold text-4xl m-5 flex-center not-phone:justify-start">Skills</h1>
